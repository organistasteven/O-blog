        ...
        <div class="posts">
          <article class="post">
            ...
            <div class="post__meta">
              <img class="post__author-icon" src="./wp-content/themes/onews/assets/images/icon-dar.png" alt="">
          ...
          <article class="post">
            ...
            <div class="post__meta">
              <img class="post__author-icon" src="./wp-content/themes/onews/assets/images/icon-john.png" alt="">
          ...
          <article class="post">
            ...
            <div class="post__meta">
              <img class="post__author-icon" src="./wp-content/themes/onews/assets/images/icon-ohz.png" alt="">
          ...
          <article class="post">
            ...
            <div class="post__meta">
              <img class="post__author-icon" src="./wp-content/themes/onews/assets/images/icon-spr.png" alt="">
          ...
          <article class="post">
            ...
            <div class="post__meta">
              <img class="post__author-icon" src="./wp-content/themes/onews/assets/images/icon-tr.png" alt="">
